...
[CreateAssetMenu(fileName = "New Shark Procedural Movement", menuName = "Creature Movement/Shark Procedural")]
public class SharkProceduralMovement : CreatureMovementBehaviour
{
    private Creature myCreature;

    [Header("Shark Specific Data")]
    ...
    public override void UpdateMovement()
    {
        switch (curState)
        {
            case MovementState.Standard:
                ...
                headTransform.localRotation = Quaternion.Euler(0, 0, maxHeadRotationAngle * Mathf.Sin(headRotationSpeed * Time.time));
